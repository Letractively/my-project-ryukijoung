        ...
        <div class="row-fluid">
            ...
            <div class="span9">
                <div class="doc-content-box">
                    ...
                    나의 정보 보기<br />
                    <br />
                    회원 닉네임 --&gt;<a href="#A"><input id="txtNIck" type="text"></a>
                    <input id="Reg" type="button" value="변경" /><br />
                    회원 아이디 : <span id="txtUserID" />
                    <br />
                    위치 :
                    <input id="txtLocation" type="text" value="대한민국 서울" /><br />
                    비밀번호 변경 --&gt;<a href="#A"><input id="txtPW" type="text"></a>
                    <input id="Reg0" type="button" value="변경" /><br />
                    <br />
                    선호하는 태그3개 리스트
                                    <a href="#A">
                                        <input id="txtTag" type="text"></a>
                    <input id="Reg1" type="button" value="변경" /><br />
                    <br />
                    자기 소개 -- &gt;&nbsp;
                                    <a href="#A">
                                        <input id="txtDoc" type="text"></a>
                    <input id="Reg2" type="button" value="변경" /><br />
                    <br />
                    &nbsp;<br />
                </div>
                <!--/.doc-content-box -->
